 ...
 */
public class ChangeLoginPhoneNumberActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_login_phone_number);
        initToolbar();
        ...
        mConfirmTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ChangeLoginPhoneNumberActivity.this, ChangeLoginPhoneNumberStepTwoActivity.class));
                finish();
            }
        });
